...
VSRSString = cell(8,1);
VSRSString{1} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v1.cfg';
VSRSString{2} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v2.cfg';
VSRSString{3} = 'cp -f tmp_I_recon_l.yuv kendo_syn_v3.yuv';
VSRSString{4} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v4.cfg';
VSRSString{5} = 'cp -f tmp_I_recon_r.yuv kendo_syn_v5.yuv';
VSRSString{6} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v6.cfg';
VSRSString{7} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v7.cfg';
VSRSString{8} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v8.cfg';

VSRSStringOri = cell(8,1);
VSRSStringOri{1} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v1_ori.cfg';
VSRSStringOri{2} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v2_ori.cfg';
VSRSStringOri{3} = 'cp -f ./data/kendo/kendo_ori_I_1.yuv kendo_syn_v3.yuv';
VSRSStringOri{4} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v4_ori.cfg';
VSRSStringOri{5} = 'cp -f ./data/kendo/kendo_ori_I_3.yuv kendo_syn_v5.yuv';
VSRSStringOri{6} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v6_ori.cfg';
VSRSStringOri{7} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v7_ori.cfg';
VSRSStringOri{8} = './code/ViewSyn ./data/kendo/config/VSRS/vsrs_kendo_v8_ori.cfg';

VSRSName = cell(8,1);
VSRSName{1} = 'kendo_syn_v1.yuv';
VSRSName{2} = 'kendo_syn_v2.yuv';
VSRSName{3} = 'kendo_syn_v3.yuv';
VSRSName{4} = 'kendo_syn_v4.yuv';
VSRSName{5} = 'kendo_syn_v5.yuv';
VSRSName{6} = 'kendo_syn_v6.yuv';
VSRSName{7} = 'kendo_syn_v7.yuv';
VSRSName{8} = 'kendo_syn_v8.yuv';
